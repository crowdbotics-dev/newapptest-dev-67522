"""
Django settings for newapptest_dev_67522 project.
...
ROOT_URLCONF = 'newapptest_dev_67522.urls'
...
WSGI_APPLICATION = 'newapptest_dev_67522.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "newapptest_dev_67522 API",
    "DESCRIPTION": "API documentation for newapptest_dev_67522 App",
    "VERSION": "v1",
}
